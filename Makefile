...
HEADERS = $(INC_DIR)/minirt.h \
		  $(INC_DIR)/utils.h \
		  $(INC_DIR)/windows.h # Assuming 'windows.h' might be for platform specific stuff, otherwise remove

# --- Compiler Flags ---
# -Wall, -Wextra, -Werror: Standard warnings and errors as mandatory by 42
# -I$(INC_DIR): Include directory for your project headers
CFLAGS =  -pthread# -Wall -Werror -Wextra -I$(INC_DIR) -g# -g for debugging
