 ...
 *
 * @details This function modifies the camera's FOV to simulate zooming in or out.
 * It clamps the FOV value between a minimum of 10 and a maximum of 170 to prevent
 * visual distortions or invalid camera states.
 *
 * @param data A pointer to the main data structure containing the scene and camera information.
 * @param zoom_factor The value by which to change the FOV. A positive value zooms in,
 ...
 * during program setup to ensure a clean starting point for mouse event handling.
 *
 * @param data A pointer to the main data structure, which contains the mouse state.
 *
 * @return void.
 */
